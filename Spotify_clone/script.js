    ...
    Array.from(card).forEach((e) => {
        e.addEventListener("click", async (event) => {
            ...
            for (const song of songs) {
                songUl.innerHTML += `<li><div class="info"><div><img class="invert" style="width:20px; padding-right:10px" src="images/songlist.svg"></img>${song.split(`${foldername}/`)[1]}</div><span><img class="invert" style="width:20px" src="images/play.svg"></img></span></div></li>`
            }
